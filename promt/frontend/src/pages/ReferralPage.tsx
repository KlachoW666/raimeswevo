...
export default function ReferralPage() {
    ...
    return (
        <div className="space-y-5 stagger-children">
            {referredBy && (
                <div className="surface-raised rounded-[14px] px-4 py-3 text-sm text-[#00E676] border-[#00E676]/20">
            ...
            <div className="surface-floating p-6 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <h2 className="text-lg font-bold mb-1 text-[#F1F5F9]">{t('referral.title')}</h2>
                    <p className="text-[#64748B] text-xs mb-5">{t('referral.subtitle')}</p>
                    <div className="bento-card rounded-[14px] flex items-center p-1.5 pl-3.5 mb-4">
                        <div className="truncate text-sm text-[#94A3B8] flex-1 font-mono">{refLink}</div>
                        <button
                            onClick={handleCopy}
                            className={`w-10 h-10 rounded-[10px] flex items-center justify-center ml-2 transition-all duration-300 active:scale-90 shrink-0 ${copied ? 'surface-raised text-[#00E676] border border-[#00E676]/40' : 'btn-primary'}`}
                        >
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="stat-card">
                    <div className="w-9 h-9 rounded-[12px] bg-[#60A5FA]/10 flex items-center justify-center mb-3">
                        <Users size={16} className="text-[#60A5FA]" />
                    </div>
                    <div className="text-2xl font-bold font-mono text-[#F1F5F9] mb-1">{refInfo?.invitedCount ?? 0}</div>
                ...
                <div className="stat-card glow-green">
                    <div className="w-9 h-9 rounded-[12px] bg-[#00E676]/10 flex items-center justify-center mb-3">
            ...
            <div className="bento-card p-5 text-xs text-[#94A3B8] leading-relaxed">
                <strong className="text-[#F1F5F9] text-sm">{t('referral.howItWorks')}</strong>
